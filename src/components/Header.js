...
const Header = () => {
  ...
  <header className="flex items-center justify-between px-10 py-3 border-b border-solid border-b-[#e7edf3]">
    ...
    <nav className="flex items-center gap-8">
      ...
      <Link to="/client-anaylsis" className="text-[#0e141b] text-sm font-medium leading-normal hover:text-blue-300 transition-colors">
        Client Analysis
      </Link>
      <Link to="about-us" className="text-[#0e141b] text-sm font-medium leading-normal hover:text-blue-300 transition-colors">
        About us
      </Link>
      <Link to="contact-us" className="text-[#0e141b] text-sm font-medium leading-normal hover:text-blue-300 transition-colors">
        Contact
      </Link>
    </nav>
